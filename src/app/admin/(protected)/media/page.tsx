...
type ImageSlot = { slot: string; url: string; alt: string };
...
const SLOT_LABELS: Record<string, { title: string; description: string }> = {
  ...
  banner_home: {
    ...
    description: "Gambar utama yang tampil di hero section halaman depan.",
  },
  about_image: {
    title: "Gambar Tentang Kami",
    description: "Gambar pendamping pada bagian filosofi/tentang kami.",
  },
};
...
export default function AdminMediaPage() {
  ...
  async function handleUpload(slot: string, file: File) {
    ...
    try {
      ...
      setImages((prev) => ({ ...prev, [slot]: saveData.image }));
